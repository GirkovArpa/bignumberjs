...
function sanitize_input_string(num) {
    const output= ('' + num).replace(/(-?)(\d*)\.?(\d+)e([+-]\d+)/,
        function (a, b, c, d, e) {
            return e < 0
...
var BigNumber = /** @class */ (function () {
    ...
    BigNumber.from = function (value) {
        ...
        if (typeof (value) === "string") {
            ...
            return new BigNumber(_constructorGuard, toHex(new BN(sanitize_input_string(value))));
...
console.log(
    ...
    BigNumber.from("5.15040759380567e+28")
);